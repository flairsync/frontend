...
import { LogOut, User, Settings, Building2, Sun, Moon, Monitor, AlertTriangle, ALargeSmall, Briefcase } from "lucide-react";
        ...
        <Sheet>
            ...
            <SheetContent side="bottom" className="rounded-t-3xl pb-8 max-h-[85dvh] overflow-y-auto">
                ...
                <div className="space-y-1 pb-4">
                    {user?.verified === false && (
                        <a href="/verify" className="flex items-center gap-3 w-full px-3 py-3 rounded-xl hover:bg-red-500/5 text-sm font-medium text-red-600 transition-colors">
                            <AlertTriangle className="w-4 h-4" /> {t("shared.user_menu.verify_email", "Verify Email")}
                        </a>
                    )}
                    ...
                    <a href="/profile/jobs" className="flex items-center gap-3 w-full px-3 py-3 rounded-xl hover:bg-primary/5 text-sm font-medium transition-colors">
                        <Briefcase className="w-4 h-4 text-muted-foreground" /> {t("shared.user_menu.jobs", "Jobs")}
                    </a>
