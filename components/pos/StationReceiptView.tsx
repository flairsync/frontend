    ...
    if (!receipt) {
        return (
            <div className="p-8 text-center text-muted-foreground">
                <p className="text-sm">Receipt unavailable</p>
    ...
    return (
        <div className="flex flex-col max-h-[80vh]">
            <div className="flex-1 overflow-y-auto">
                ...
                >
                    ...
                    <div className="text-center py-4 border-b border-border">
                        <p className="text-base font-bold uppercase tracking-widest">Receipt</p>
            ...
            <div className="flex gap-2 p-4 border-t border-border bg-card">
                ...
                {onNewOrder ? (
                    <Button className="flex-1" onClick={onNewOrder}>New Order</Button>
                ) : (
