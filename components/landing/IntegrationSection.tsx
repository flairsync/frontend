...
const IntegrationSection = () => {
    ...
    return (
        <div className="flex justify-center items-center bg-background font-sans text-foreground py-16 px-4">
            <div className="w-full max-w-7xl bg-primary rounded-3xl p-6 sm:p-10 md:p-16 flex flex-col lg:flex-row items-center justify-between relative overflow-hidden shadow-2xl">
                {/* Left Section */}
