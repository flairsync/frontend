...
const IntegrationSection = () => {
    ...
    return (
        <div className="scroll-container flex justify-center items-center min-h-screen bg-background font-sans text-foreground py-16 px-4">
            <div className="w-full max-w-7xl bg-primary rounded-3xl p-8 md:p-16 flex flex-col lg:flex-row items-center justify-between relative overflow-hidden shadow-2xl min-h-[550px]">
                {/* Left Section */}
                <div className="flex-1 max-w-lg z-10 text-center lg:text-left mb-12 lg:mb-0">
                    ...
                    <Button className="bg-white text-primary font-semibold py-6 px-8 hover:cursor-pointer text-lg hover:bg-white/90 transition-colors duration-200 rounded-xl shadow-lg">
                ...
                <div className="flex-1 flex justify-center items-center relative w-full lg:w-1/2 min-h-[400px]">
                    {/* Main Card */}
                    <Card className="relative lg:absolute lg:top-1/4 lg:right-20 w-72 h-96 sm:w-[300px] sm:h-[400px] bg-white rounded-xl shadow-2xl transform rotate-6 hover:rotate-0 transition-transform duration-500 z-10 border-0">
                        <CardContent className="p-6">
                            ...
                            <div className="flex justify-between items-end">
                                <div className="w-full h-20 bg-gray-50 rounded-lg border border-gray-100 overflow-hidden">
                    ...
                    <Card className="absolute bottom-10 left-10 lg:left-auto lg:right-80 w-20 h-20 sm:w-24 sm:h-24 bg-white/90 backdrop-blur-sm rounded-xl shadow-lg transform -rotate-6 z-20 flex items-center justify-center border-0">
