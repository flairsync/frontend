...
const LandingHero = () => {
    ...
    return (
        <section className="relative w-full pt-20 md:pt-24 pb-12 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col-reverse md:flex-row items-center md:items-start gap-8 md:gap-12">
                {/* Left section */}
                <div className="flex-1 text-center md:text-left flex flex-col justify-center">
                    <h1 className="title_text leading-[1.2] text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold text-foreground mb-4 md:mb-6">
                        {t("landing_page.hero.title")}
                    </h1>
                    <p className="description_text text-base sm:text-lg md:text-2xl text-foreground/80 mb-6 md:mb-8 max-w-2xl mx-auto md:mx-0">
