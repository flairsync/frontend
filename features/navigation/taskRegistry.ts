...
export const APP_TILES: AppTile[] = [
    ...
    {
        key: "data-export",
        labelKey: "simple_mode.tiles.data_export.label",
        descriptionKey: "simple_mode.tiles.data_export.description",
        synonymsKey: "simple_mode.tiles.data_export.synonyms",
        icon: DatabaseBackup,
        accent: "sky",
        section: "setup",
        roles: ["owner"],
